...
<head>
    ...
    <title>Home Page - Online Birth Certificate Management System</title>
...
<body>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.php">Online Birth Certificate Management System</a>
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/bg-img/bg-file.jpg);">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Online Birth Certificate Management System 
